                            ...
                            <div id="collapseSix" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body category-scroll">
                                    <ul class="category-list">
                                        ...
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" id="ct1{{$category->id}}" name="categories" type="checkbox" value="{{$category->id}}" @if(in_array($category->id,explode(',',$q_categories))) checked="checked" @endif onchange="filterProductsByCategory(this)">
